...
try
{
  // make new db
   ...
   //sql statement
   $theQuery = 'CREATE TABLE flowers (flowerID INTEGER PRIMARY KEY NOT NULL, color INTEGER, shape INTEGER, row INTEGER, xPos INTEGER, creationDate TEXT, creationTime INTEGER, user TEXT)';
